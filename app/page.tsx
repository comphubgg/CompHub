  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-slate-100">
      ...
      {/*
        * Die Fusszeile.
        *
        * Vorher stand hier ein einzelner X-Verweis und ein Halbsatz. Fuer eine
        * Seite, die Moderatoren und Profispielern gezeigt wird, ist das zu
        * wenig: wer wissen will, wem das Werkzeug gehoert und wie man den
        * Betreiber erreicht, soll nicht suchen muessen.
        *
        * Drei Spalten, weil es drei Fragen sind: was ist das hier, was gibt es
        * darin, und wie erreicht man jemanden. Der Hinweis auf Epic steht
        * unten und nicht klein am Rand - er ist keine Fussnote, sondern eine
        * Klarstellung.
        */}
