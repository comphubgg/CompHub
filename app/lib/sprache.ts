...
const AUF_ENGLISCH: Record<string, string> = {
  ...
  'Erscheint in der Statistik unter Organizations. Spieler hängen an ihrem Epic-Konto; ohne Konto stehen sie ohne Profil und ohne Preisgeld da.': 'Shown in Statistics under Organizations. Players are tied to their Epic account; without an account they appear without a profile and without prize money.',
  'Neue Organisation': 'New organization',
  'Organisation wählen oder neu anlegen.': 'Choose an organization or create a new one.',
  'kein Logo': 'no logo',
  'Logo hochladen': 'Upload logo',
  'Logo entfernen': 'Remove logo',
  'Name der Organisation': 'Organization name',
  'Webseite (freiwillig)': 'Website (optional)',
  'X-Konto (freiwillig)': 'X account (optional)',
  'Weitere Einnahmen': 'Other winnings',
  'Was die Organisation selbst bekommt, etwa den EWC Club Bonus. Zählt im Jahr seines Datums.': 'What the organization itself receives, such as the EWC club bonus. Counts in the year of its date.',
  'Einnahme notieren': 'Add winnings',
  'Wirklich löschen? Spieler und Einnahmen dieser Organisation sind danach weg.': 'Delete for real? The players and winnings of this organization will be gone.',
  'Ja, löschen': 'Yes, delete',
  'Organisation löschen': 'Delete organization',
  'Wird gespeichert …': 'Saving …',
  'Konto zuweisen …': 'Link account …',
  'Spieler hinzufügen: Namen tippen …': 'Add player: type a name …',
  'Titel, z. B. EWC Club Championship': 'Title, e.g. EWC Club Championship',
  'Betrag in $': 'Amount in $',
  'Organisationen': 'Organizations',
  'Alle Organisationen': 'All organizations',
  'Für die Organisation gewonnen': 'Won for the organization',
  'Teil von': 'Part of',
  'seit': 'since',
  'Kein Konto verknüpft': 'No account linked',
  'Wird innerhalb der nächsten Stunde gerechnet': 'Calculated within the next hour',
  'bezahltes Turnier': 'paid event',
  'bezahlte Turniere': 'paid events',
  'Profil öffnen': 'Open profile',
  'Weitere Einnahmen der Organisation': 'Other winnings of the organization',
  'Noch keine Organisationen': 'No organizations yet',
  'Die Organisationen ließen sich gerade nicht laden.': 'The organizations could not be loaded right now.',
  'Preisgeld für die Organisation, gezählt ab dem Beitritt jedes Spielers': "Prize money won for the organization, counted from each player's join date",
  'Preisgeld aus Epics Ergebnissen und Auszahlungstabellen und von den LAN-Events, je Spieler ab dem Tag seines Beitritts.': "Prize money from Epic's results and payout tables plus LAN events, per player from the day they joined.",
  'weiter bis Platz': 'advance down to place',
  'Weiter, Platz 1 bis': 'Advance, rank 1 to',
  'Sieger markiert': 'winner highlighted',
  'Siegerteam': 'Winner',
  'ja': 'yes',
  'nein': 'no',
  'und': 'and',
  ...
  'Epics Rangliste war beim letzten Abruf nur teilweise erreichbar.': "Epic's ranking page was only partly reachable during the last update.",
  'Hier stehen die Plätze': 'This list shows ranks',
  'Plätze fehlen': 'ranks are missing',
  'Der nächste vollständige Abruf ersetzt die Liste von selbst.': 'The next complete update replaces the list automatically.',
  'Inaktiv': 'Inactive',
  'Keine Antwort': 'No response',
  'Dieser Server ist gerade inaktiv.': 'This server is currently inactive.',
  'nobleprac.com antwortet gerade nicht.': 'nobleprac.com is not responding right now.',
  'Kein Spieler dieser Session hat ein Land hinterlegt.': 'No player in this session has set a country.',
  'Noble und Poyo sind echt, von nobleprac.com und scrims.poyocup.com, seit dem 21.9. gesammelt und stündlich ergänzt. Die Kacheln mit „Beispiel“ zeigen, wie ein Server aussieht, sobald er verbunden ist. Deren Zahlen sind nicht echt.': 'Noble and Poyo are real, from nobleprac.com and scrims.poyocup.com, collected since 21 September and updated every hour. Tiles marked "Example" show how a server looks once it is connected. Their numbers are not real.',
  'Daten von': 'Data from',
  'Lobbys': 'Lobbies',
  'Format': 'Format',
  'Plattformen': 'Platforms',
  'Nur Mobile (Touch-Steuerung)': 'Mobile only (touch controls)',
  'Regeln zeigen': 'Show rules',
  'Regeln ausblenden': 'Hide rules',
  'Diese Session hat noch nicht begonnen. Das Leaderboard steht hier, sobald die erste Runde gespielt ist.': 'This session has not started yet. The leaderboard appears here once the first round is played.',
  'Die Session läuft, es gibt aber noch keine Einträge. Sie erscheinen nach der ersten gewerteten Runde.': 'The session is running but has no entries yet. They appear after the first scored round.',
  'Nicht verbunden': 'Not connected',
  'Server beitreten': 'Join server',
  'Keine Sessions seit': 'No sessions since',
  'Punkte der Spieler': 'Player points',
  'Spieler-Details': 'Player details',
  'Privat': 'Private',
  'Dieser Server zeigt seine Sessions nicht öffentlich.': 'This server does not show its sessions publicly.',
  'Die Herkunft der Spieler nennt die Quelle nicht.': "The source does not list the players' countries.",
  'Das nennt die Quelle zu dieser Session nicht.': 'The source does not list this for the session.',
  'Die Quelle gibt dieses Leaderboard gerade nicht heraus, auch dort lässt es sich nicht öffnen. Jüngere Sessions stehen meist vollständig da.': 'The source is not providing this leaderboard right now, it cannot be opened there either. More recent sessions are usually complete.',
  'Zu dieser Session hat die Quelle keine Einträge. Gespielt wurde offenbar nicht.': 'The source has no entries for this session. It apparently was not played.',
  'betreut': 'manages',
  'nicht mit Discord verknüpft': 'not linked to Discord',
  'abgelaufen am': 'expired on',
  'wird gelöscht': 'will be deleted',
  'gültig bis': 'valid until',
  'danach gelöscht': 'deleted afterwards',
  'Erst mit Discord verknüpfen': 'Link to Discord first',
  'Chat öffnen': 'Open chat',
  'Frist setzen': 'Set end date',
  'Discord verknüpfen': 'Link Discord',
  'Gültig bis': 'Valid until',
  'Frist setzen und per DM mitteilen': 'Set end date and tell them by DM',
  'Ohne Ende': 'No end date',
  ['Der Bot schickt der Person das Datum. Ist es erreicht, wird der Zugang gelöscht, samt Rollen und Kanal.']: 'The bot sends the person the date. When it is reached, the access is deleted, with its roles and channel.',
  'Discord-Name suchen': 'Search Discord name',
  'Niemand auf dem Server gefunden.': 'Nobody found on the server.',
  'Grund (geht als DM vom CompHub-Bot an die Person)': 'Reason (sent to the person as a DM from the CompHub bot)',
  ['Zugang wirklich löschen? Anmeldung, Rollen und Kanal sind danach weg.']: 'Really delete this access? Sign-in, roles and channel will be gone.',
  'Zugang löschen und Grund senden': 'Delete access and send the reason',
  'Nicht ladbar.': 'Could not be loaded.',
  'Abgelaufen und gelöscht': 'Expired and deleted',
  'VIP-Zugänge': 'VIP access',
  ['Jeder Zugang mit Frist, Chat und Löschen. Was die Person erreicht, schickt der CompHub-Bot.']: 'Every access with end date, chat and delete. Whatever reaches the person is sent by the CompHub bot.',
  'Zugang oder Discord-Name suchen': 'Search access or Discord name',
  'Frist, Chat und Löschen je VIP': 'End date, chat and delete for every VIP',
  ...
  'Doppelt (schärfer)':
    'Double (sharper)',
  'Trag die Browser-Quelle in OBS mit der doppelten Breite und Höhe ein und zieh sie in der Szene auf 50 % — dann wird nichts hochgerechnet und alles ist scharf.':
    'Enter the browser source in OBS at double the width and height and scale it to 50 % in the scene — then nothing is upscaled and everything is sharp.',
  'Unscharf in OBS? Zieh die Quelle in der Szene nie größer, als sie eingetragen ist. Mit „Schärfe: Doppelt“ wird alles doppelt so groß gezeichnet — Quelle doppelt so groß eintragen, in der Szene auf 50 %.':
    'Blurry in OBS? Never scale the source up in the scene beyond the size it is entered at. With "Sharpness: Double" everything is drawn twice as large — enter the source twice as large and scale it to 50 % in the scene.',
  'Größe der Bilder':
    'Photo size',
  'Eigener Text':
    'Custom text',
  ...
  'Als Manager wählst du den Spieltag, um den es gerade geht: was läuft, was heute schon lief, und was gleich anfängt — in Europa ab 15 Minuten vorher, in den anderen Regionen ab zwei Stunden vorher.':
    'As a manager you pick the match day that is actually on: what is running, what ran earlier today, and what is about to start — in Europe from 15 minutes before, in the other regions from two hours before.',
  'Gerade läuft kein Spieltag und keiner fängt gleich an. Sobald einer ansteht, erscheint er hier von selbst.':
    'No match day is running and none is about to start. As soon as one comes up it appears here on its own.',
  'Neu':
    'New',
