...
const AUF_ENGLISCH: Record<string, string> = {
  ...
  'Das nennt nobleprac.com zu dieser Session nicht.': 'nobleprac.com does not list this for the session.',
  'Daten von nobleprac.com': 'Data from nobleprac.com',
  'nobleprac.com gibt dieses Leaderboard gerade nicht heraus — auch dort lässt es sich nicht öffnen. Jüngere Sessions stehen meist vollständig da.': 'nobleprac.com is not providing this leaderboard right now — it cannot be opened there either. More recent sessions are usually complete.',
  'Zu dieser Session hat nobleprac.com keine Einträge — gespielt wurde offenbar nicht.': 'nobleprac.com has no entries for this session — it apparently was not played.',
  'Noble ist echt (von nobleprac.com). Die Kacheln mit „Beispiel“ zeigen, wie ein Server aussieht, sobald er verbunden ist — keine dieser Zahlen ist echt.': 'Noble is real (from nobleprac.com). Tiles marked "Example" show how a server looks once it is connected — none of their numbers are real.',
  'betreut': 'manages',
