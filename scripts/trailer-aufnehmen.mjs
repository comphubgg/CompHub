...
const SZENEN = [
  ...
  { name: '05-event', pfad: '/events/s39_perfeval', titel: 'Every match day',
    ...
    warten: 8000 },
  { name: '06-statistik', pfad: '/statistics', titel: 'Statistics',
    unter: 'Damage, mats, builds — numbers Epic never publishes',
    warten: 7000 },
  { name: '07-turniere', pfad: '/statistics', titel: 'Every past final',
  ...
  { name: '08-regionen', pfad: '/statistics', titel: 'Seven regions',
  ...
  { name: '09-spieler', pfad: '/statistics', titel: 'Player profiles',
  ...
  { name: '10-tierlist', pfad: '/tierlist', titel: 'Tierlist',
    ...
    warten: 9000 },
  { name: '11-karten', pfad: '/maps', titel: 'Drop maps',
  ...
  { name: '13-anmelden', pfad: '/sign-in', titel: 'Sign up',
