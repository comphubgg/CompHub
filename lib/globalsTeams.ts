...
import { gecacht, holeTop } from '@/lib/epicCups';
...
/* Die Qualifikationsregion je Team steht in lib/globalsRegionen. */
...
/** Das Feld eines Spieltags mit Namen, Laendern, Fotos und Region - siehe oben. */
export async function globalsTeams(fenster: string) {
